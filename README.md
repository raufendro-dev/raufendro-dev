...
#### Check my vscode extension [Flutter Create Model]([https://pub.dev/packages/ez_alarm](https://marketplace.visualstudio.com/items?itemName=raufendro-dev.flutter-create-model))
